...
func CreateVoiceAgentAPIRequest(voiceAgent VoiceAgent) (*agent_api.CreateAgentRequest, error) {
	return createVoiceAgentAPIRequest(voiceAgent, false, nil)
}
...
func CreateVoiceAgentAPIRequestFlat(voiceAgent VoiceAgent) (*agent_api.CreateAgentRequest, error) {
	return createVoiceAgentAPIRequest(voiceAgent, true, nil)
}

// CreateHostedVoiceAgentAPIRequestFlat builds a hosted-agent voice wrapper using
// the deployed target resolved by the project layer.
func CreateHostedVoiceAgentAPIRequestFlat(
	voiceAgent VoiceAgent,
	target agent_api.VoiceTargetAgentReference,
) (*agent_api.CreateAgentRequest, error) {
	return createVoiceAgentAPIRequest(voiceAgent, true, &target)
}
